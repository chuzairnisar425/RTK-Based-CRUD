    ...
    <div className="bg-[#FAFBFF] dark:bg-slate-950 min-h-screen pb-20 transition-colors duration-500">
      ...
      <article className="max-w-3xl mx-auto mt-8 px-6">
        ...
        <section className="prose prose-slate dark:prose-invert lg:prose-xl max-w-none">
          <p className="text-xl md:text-2xl text-slate-700 dark:text-slate-300 leading-relaxed font-medium first-letter:text-5xl first-letter:font-black first-letter:text-emerald-600 dark:first-letter:text-emerald-400 first-letter:mr-3 first-letter:float-left">
            {post.body}
          </p>
          ...
          <p className="mt-8 text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            ample white space and deliberate typography, we respect the reader's
            attention.
          </p>
        </section>
